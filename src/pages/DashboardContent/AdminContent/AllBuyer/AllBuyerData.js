...
const AllBuyerData = ({ buyer, setDeletingBuyer }) => {
        ...
        <tr className=" border-b dark:bg-gray-800 dark:border-gray-700">
            ...
            <td className="py-4 px-6">
                <div className='flex'>
                    ...
                    <label onClick={() => setDeletingBuyer(buyer)} htmlFor="confirmation-modal" title='Delete Buyer' className="text-2xl text-red-500"><AiFillDelete className='mx-4' /></label>
                </div>
            </td>
        </tr>
    );
