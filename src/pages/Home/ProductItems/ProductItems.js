    ...
    return (
        <div className="max-w-sm rounded-md shadow-md dark:bg-teal-700 dark:text-gray-100">
            ...
            <div className="flex flex-col justify-between p-6 space-y-8">
                ...
                <div className=''>
                    <Link to={`/category/${categoryName}`} className="flex items-center justify-center w-full p-3 font-semibold rounded-md outline outline-1 bg-amber-500 transition ease-in duration-200 hover:text-gray-800 text-gray-200">View</Link>
                </div>
            </div>
        </div>
    );
